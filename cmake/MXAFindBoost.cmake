...
IF (NOT DEFINED BOOST_CURRENT_VERSION)
     SET ( BOOST_CURRENT_VERSIONSLASH "1_34_1")
ELSE (NOT DEFINED BOOST_CURRENT_VERSION)
     SET ( BOOST_CURRENT_VERSIONSLASH "${BOOST_CURRENT_VERSIONSLASH}")
...
ELSE (BOOST_LIBRARIES AND BOOST_INCLUDE_DIRS)
   ...
   SET(BOOST_PATH_SUFFIX
     boost${BOOST_CURRENT_VERSIONSLASH}
   )
...
#-------------------------------------------------------------------------------
   ...
   IF ( NOT DEFINED BOOST_LIBRARIES_SUFFIX )
	   ...
	   IF (UNIX)
	     ...
	     ENDIF (APPLE)
	   ENDIF(UNIX)
   ELSE( NOT DEFINED BOOST_LIBRARIES_SUFFIX )
    SET(BOOST_COMPILER "${BOOST_LIBRARIES_SUFFIX}")
   ENDIF( NOT DEFINED BOOST_LIBRARIES_SUFFIX )
...
# -------- Find the date_time Library -------------
  ...
  SET (BOOST_DEBUG_LIB_NAME boost_${BOOST_LIB}${BOOST_COMPILER}${BOOST_MULTITHREADED}${BOOST_ABI_TAG}${BOOST_CURRENT_VERSIONSLASH})
  SET (BOOST_RELEASE_LIB_NAME boost_${BOOST_LIB}${BOOST_COMPILER}${BOOST_MULTITHREADED}${BOOST_CURRENT_VERSIONSLASH})
