...
namespace Lucene
{
	class LPPCONTRIBAPI UTF8Stream : public LuceneObject
	{
	public:
	...
	class LPPCONTRIBAPI UTF8Encoder : public UTF8Stream
	{
	public:
	...
	class LPPCONTRIBAPI UTF8Decoder : public UTF8Stream
	{
	public:
	...
	class LPPCONTRIBAPI UTF16Decoder : public UTF8Stream
	{
	public:
